...
import { extractNaverPostId, findRecentlyPublishedRssItem } from './NaverRss';
...
// RSS 재검증 함수(parseNaverRss·findRecentlyPublishedRssItem·extractNaverPostId)는
// playwright 의존이 없는 NaverRss.ts로 옮겼다(로봇이 이 파일을 import하지 않도록).
// 기존 import 경로를 유지하기 위해 여기서 재export한다.
export {
  extractNaverPostId,
  parseNaverRss,
